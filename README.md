# Código MATLAB del Artículo Científico *"Aspectos Computacionales del Problema de Fermat-Weber y sus Algoritmos de Solución"*
...
* Este repositorio contiene el código desarrollado en MATLAB de las simulaciones numéricas presentadas en el artículo científico "*Aspectos Computacionales del Problema de Fermat-Weber y sus Algoritmos de Solución*". Este artículo está disponible en la base de datos de **SciELO Preprints**. En enlace del artículo científico es https://doi.org/10.1590/SciELOPreprints.4669
